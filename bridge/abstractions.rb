...
class Robot < Entity
  ...
  def action
    puts terminal_add("SECTOR: #{room.label.upcase}, PURPOSE: #{room.type.upcase}")
    analyze
    find_objects
...
class CarefulMan < Entity
  ...
  def introduce
    puts "My name is Mr.#{full_name} and I shall not do anything, until I shall be sure what I see. So..."
  end
end