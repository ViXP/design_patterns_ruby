# The editorial office of local magazine has a lot of departments. Each department
# prepared its own article so the chief editor must decide in which order to
# assemble them and to declare the sequence of delivery of finished materials.
# 
...
request1 = EditorialOrder.new(:investigation, :news, :sport, :news, :culture, :news, :print)

# The automatic sequence of handlers dependent on the sequence of links in the chain:
...
# Because the chain is closed it's not important from which element handling is started:
