...
puts <<~TEXT
  ...
  We can sell you the several types of our wellmade products, please, choose
  the one you are interested in:
  - Our fine dreadnought acoustic guitars (type 'A6' for 6 strings; 'A12'
    for 12 strings)
  - Our classic acoustic guitars (type 'CS')
  - Our amazing electric guitars (type 'E6' for 6 strings; 'E7' for 7 strings)
  - Our great sounding bass guitars (type 'B4' for 4 strings; 'B5' for
    5 strings)
