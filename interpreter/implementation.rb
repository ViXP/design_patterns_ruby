...
# using the concrete EngExpression and MorzeExpression terminals (don't use '.'
# and '-' symbols in English sentences).
#
# CONTEXT Context
...
# Interpreting using the predefined DSL expressions:
result1 = TranslaterExpression.new(
  'Mister Sandman, bring me a dream! translate to Mor').interprete
