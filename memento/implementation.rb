# The program gives a writer the functionality of version control system for his
# work on the new chapters of a book. He can edit the chapter, save his work,
# watch the history of saved states and restore the previous states if he needs
# to.
#
# MEMENTO TextChunk
...
puts chapter1.show_state # shows the current edit
chapter1.save_state

# Editing & saving the second memento:
chapter1.set_state(nil, 'Some new text of the chapter')
puts chapter1.show_state # shows the current edit
chapter1.save_state
...
chapter1.set_state '~', '~'
puts chapter1.show_state # data is lost, so user must restore his work

# Shows the history of saved mementos:
puts chapter1.history

# Let user specify the version of memento he wish to rollback:
chapter1.restore gets.chomp
# If nothing is specified - the caretaker will rollback to previous saved state
puts chapter1.show_state # shows the restored state
